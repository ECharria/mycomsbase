  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 40 }}>
        {/* Left: logo (already contains icon + wordmark) + tagline */}
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <img
            src={mycomsLogo}
            alt="MycoMSBase"
            style={{ height: 90, objectFit: 'contain', objectPosition: 'left' }}
          />
          <div>
            <p
              style={{
        ...
        {/* Right: spectrum image in a soft card */}
        <div
          style={{
            flexShrink: 0,
            width: 380,
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        <Input
          ...
          placeholder="Search by Accession ID, Compound name, m/z, or InChIKey..."
          value={query}
