...
type DefaultAPIServicer interface { 
	GetRecords(context.Context, []string, []string, []string, string, string, string, string, string, float64, string, []string, int32, []string, []string, float64, string, string, string, string, string, string, string, string, string, string) (ImplResponse, error)
	GetSearchResults(context.Context, []string, []string, []string, string, string, string, string, string, float64, string, []string, int32, []string, []string, float64, string, string, string, string, string, string, string, string, string, string) (ImplResponse, error)
